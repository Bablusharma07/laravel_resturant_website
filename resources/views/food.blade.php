 ...
 <section class="section" id="menu">
        ...
        <div class="menu-item-carousel">
            <div class="col-lg-12">
                ...
                @foreach($data->all() as $food_details)
                <div class="item">
                        <div style="background-image: url('/foodimage/{{$food_details->image}}')" class='card'>
                            <div class="price"><h6>${{$food_details->price}}</h6></div>
                            <div class='info'>
                              <h1 class='title'>{{$food_details->title}}</h1>
                              <p class='description'>{{$food_details->description}}.</p>
